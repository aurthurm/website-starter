// credits for carousel: https://flowbite.com/
...
class Carousel {
    ...
    _init() {
        ...
        this._indicators.map((indicator: any, position: any) => {
    ...
    _setActiveItem(position: number) {
        ...
        if (this._indicators.length) {
            this._indicators.map((indicator: any) => {
...
document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('[data-carousel]').forEach(carouselEl => {
        ...
        if (carouselEl.querySelectorAll('[data-carousel-item]').length) {
            [...(carouselEl.querySelectorAll('[data-carousel-item]') as any)].map((carouselItemEl, position) => {
                items.push({
                    position: position,
                    el: carouselItemEl
                })
        ...
        if (carouselEl.querySelectorAll('[data-carousel-slide-to]').length) {
            [...(carouselEl.querySelectorAll('[data-carousel-slide-to]') as any)].map((indicatorEl) => {
                indicators.push({
